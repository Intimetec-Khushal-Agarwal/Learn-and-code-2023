...
public class EmailNotificationService {
	...
	public static void successNotification(String recipientEmail) {
		...
		sendNotificationEmail(subject,body,recipientEmail);
	}

	public static void failureNotification(String recipientEmail) {
		String subject = "Error Notification";
		String body = "This is to inform that the user already exists in the database";
		sendNotificationEmail(subject,body,recipientEmail);
	}

	public static void sendNotificationEmail(String subject,String body,String recipientEmail ) {
		try {
